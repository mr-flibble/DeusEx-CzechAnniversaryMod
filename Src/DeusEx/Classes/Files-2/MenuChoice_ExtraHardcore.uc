...
{
     defaultInfoWidth=98
     HelpText="If set to Enabled, hardcore mode's save points require 100 credits to use & the run key (default: Shift) must be held down to run. For veterans only."
