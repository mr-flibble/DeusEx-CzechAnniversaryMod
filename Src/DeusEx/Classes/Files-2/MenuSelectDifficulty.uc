...
defaultproperties
{
     ...
     HardcoreUnlockDescription="Complete GMDX on any difficulty mode to unlock Hardcore Mode."
     ButtonNames(0)="Easy"
     ButtonNames(1)="Medium"
     ButtonNames(2)="Realistic"
     ButtonNames(3)="Hardcore"
     ...
     buttonDefaults(3)=(Y=121,Action=MA_Custom,Key="HARDCORE")
     buttonDefaults(4)=(Y=178,Action=MA_Previous)
