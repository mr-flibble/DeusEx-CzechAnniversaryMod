...
defaultproperties
{
     ...
     PerksDescription="|nAn agent's standing accuracy bonus with rifles is accelerated by 30%. |n|nRequires: Rifles: TRAINED"
     PerksDescription2="|nAn agent aims down a rifle's scope 30% faster.|n|nRequires: Rifles: ADVANCED"
     PerksDescription3="|nAn agent handles rifle recoil efficiently and sway when looking through a rifle's scope is reduced marginally. |n|nRequires: Rifles: MASTER"
