...
event bool VirtualKeyPressed(EInputKey key, bool bRepeat)
{
    ...
    /*  //CyberP: need to figure out a way to let the player move with real-time UI
	...
	optional Bool bNoPause)
{
	...
	if (Player.bHardCoreMode || Player.bRealUI)
	   bNoPause = True;
...
function ExitGame()
{
	if (parentPawn!=none&&parentPawn.IsA('DeusExPlayer')&&DeusExPlayer(parentPawn).Weapon!=none&&DeusExPlayer(parentPawn).Weapon.IsA('WeaponNanoSword'))
	{
