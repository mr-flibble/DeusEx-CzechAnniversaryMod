...
event DrawWindow(GC gc)
{
    ...
    gc.SetTextColor(col02);//gc.SetTextColor(colBar);   //CyberP: blue
	...
	//{
        ...
        gc.SetFont(Font'FontConversationBold');
           if (Player.LightLevelDisplay < 6)
              gc.SetTextColor(colLightDark);
           else if (Player.LightLevelDisplay < 11)
              gc.SetTextColorRGB(176,176,0);
           else if (Player.LightLevelDisplay < 16)
              gc.SetTextColorRGB(212,212,0);
           else
              gc.SetTextColor(colLight);
