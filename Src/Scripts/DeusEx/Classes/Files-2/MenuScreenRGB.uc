...
var localized String InfoTit;
var localized String InfoDescr;
...
local string thisMust;
	...
	if (themeMode == CTT_Menu)
	{
		...
		//SetTheme(player.ThemeManager.FindTheme(thisMust));
...
function ProcessAction(String actionKey)
{
	...
	if (actionKey == "SAVE")
	{
		...
		player.customColorsMenu[0] = player.ThemeManager.currentMenuTheme.colors[0];
		player.customColorsMenu[1] = player.ThemeManager.currentMenuTheme.colors[1];
		player.customColorsMenu[2] = player.ThemeManager.currentMenuTheme.colors[2];
		player.customColorsMenu[3] = player.ThemeManager.currentMenuTheme.colors[3];
		player.customColorsMenu[4] = player.ThemeManager.currentMenuTheme.colors[4];
		player.customColorsMenu[5] = player.ThemeManager.currentMenuTheme.colors[5];
		player.customColorsMenu[6] = player.ThemeManager.currentMenuTheme.colors[6];
		player.customColorsMenu[7] = player.ThemeManager.currentMenuTheme.colors[7];
		player.customColorsMenu[8] = player.ThemeManager.currentMenuTheme.colors[8];
		player.customColorsMenu[9] = player.ThemeManager.currentMenuTheme.colors[9];
		player.customColorsMenu[10] = player.ThemeManager.currentMenuTheme.colors[10];
		player.customColorsMenu[11] = player.ThemeManager.currentMenuTheme.colors[11];
		player.customColorsMenu[12] = player.ThemeManager.currentMenuTheme.colors[12];
		player.customColorsMenu[13] = player.ThemeManager.currentMenuTheme.colors[13];
		player.customColorsHUD[0] = player.ThemeManager.currentHUDTheme.colors[0];
		player.customColorsHUD[1] = player.ThemeManager.currentHUDTheme.colors[1];
		player.customColorsHUD[2] = player.ThemeManager.currentHUDTheme.colors[2];
		player.customColorsHUD[3] = player.ThemeManager.currentHUDTheme.colors[3];
		player.customColorsHUD[4] = player.ThemeManager.currentHUDTheme.colors[4];
		player.customColorsHUD[5] = player.ThemeManager.currentHUDTheme.colors[5];
		player.customColorsHUD[6] = player.ThemeManager.currentHUDTheme.colors[6];
		player.customColorsHUD[7] = player.ThemeManager.currentHUDTheme.colors[7];
		player.customColorsHUD[8] = player.ThemeManager.currentHUDTheme.colors[8];
		player.customColorsHUD[9] = player.ThemeManager.currentHUDTheme.colors[9];
		player.customColorsHUD[10] = player.ThemeManager.currentHUDTheme.colors[10];
		player.customColorsHUD[11] = player.ThemeManager.currentHUDTheme.colors[11];
		player.customColorsHUD[12] = player.ThemeManager.currentHUDTheme.colors[12];
		player.customColorsHUD[13] = player.ThemeManager.currentHUDTheme.colors[13];
		player.SaveConfig();
	}
	...
	else if (actionKey == "INFO")
	{
	   ...
	   root.MessageBox(InfoTit, InfoDescr, 1, False, Self);
	}
	else
	{
...
defaultproperties
{
     ...
     ThemeLabel="Theme:"
     InfoTit="Info"
     InfoDescr="Use the sliders to select the color for each individual UI element on the right. When done, click the 'Save' button which will save both your HUD and Menu. You can only have one saved HUD & UI theme at a time."
     ...
     actionButtons(4)=(Align=HALIGN_Right,Action=AB_Other,Text="|&Help",Key="INFO")
