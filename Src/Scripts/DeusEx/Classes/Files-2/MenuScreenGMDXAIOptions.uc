...
defaultproperties
{
     ...
     choices(4)=Class'DeusEx.MenuChoice_HardcoreAI3'
     choices(5)=Class'DeusEx.MenuChoice_ExtraGore'
     choices(6)=Class'DeusEx.MenuChoice_HalveAmmoCapacity'
     choices(7)=Class'DeusEx.MenuChoice_HardcoreFilter'
     choices(8)=Class'DeusEx.MenuChoice_RealisticCarci'
     choices(9)=Class'DeusEx.MenuChoice_USP'
     choices(10)=Class'DeusEx.MenuChoice_LaserRifle'
