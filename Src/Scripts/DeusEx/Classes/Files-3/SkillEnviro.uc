...
defaultproperties
{
     ...
     PerksDescription="|nAn agent's movement is not stunted when exposed to explosive and electrical-based hazards. |n|nRequires: Environmental Training: TRAINED"
     ...
     PerksDescription3="|nAn agent modifies tech goggle functionality, implementing short-ranged sonar scanning which enables the user to see potential threats through solid material. |n|nRequires: Environmental Training: MASTER"
